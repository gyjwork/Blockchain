...
async function addPurpose() {
  ...
  console.log("Encrypted data:", encryptedDataList);
  ...
  const decryptedDataList = await decryptData(encryptedDataList, privateKey);
  console.log("Decrypted data:", decryptedDataList);
}
